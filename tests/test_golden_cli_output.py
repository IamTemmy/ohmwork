...
_GOLDEN_MAXSTACK = "Candidates considered (D1/D16: every literal-minimal AOI/OAI cover):\n  AOI: F' = a + b (4 core + 0 inverter = 4 transistors) <- chosen\n  OAI: F' = a + b (4 core + 0 inverter = 4 transistors)\n\nGate: 2-input NOR\nF' = a + b\n\nTransistor count:\n  PDN (NMOS):  2\n  PUN (PMOS):  2\n  Inverters:   0 (no complemented inputs needed)\n  Total:       4\n\nStack height: PDN 1, PUN 2\n\nMinimality: proven minimal: every declared variable (2) appears exactly once as a literal, and a network realizing a function that depends on n variables needs at least n literals — no design in any search space could use fewer transistors.\n\nSchematic:\n    VDD     \n     |      \n  PUN: a·b  \n     |      \n     F      \n     |      \n PDN: a + b \n     |      \n    GND     \n\nVerification (D7, two independent checks):\n  vectors simulated: 4\n  functional equivalence: PASS\n  structural validity: PASS (no floating output, no VDD-GND short)"
...
_GOLDEN_BUFFER = "Candidates considered (D1/D16: every literal-minimal AOI/OAI cover):\n  AOI: F' = a (2 core + 0 inverter = 2 transistors) <- chosen\n  OAI: F' = a (2 core + 0 inverter = 2 transistors)\n\nGate: inverter (1 input)\nF' = a\n\nTransistor count:\n  PDN (NMOS):  1\n  PUN (PMOS):  1\n  Inverters:   0 (no complemented inputs needed)\n  Total:       2\n\nStack height: PDN 1, PUN 1\n\nMinimality: proven minimal: every declared variable (1) appears exactly once as a literal, and a network realizing a function that depends on n variables needs at least n literals — no design in any search space could use fewer transistors.\n\nSchematic:\n  VDD   \n   |    \n PUN: a \n   |    \n   F    \n   |    \n PDN: a \n   |    \n  GND   \n\nVerification (D7, two independent checks):\n  vectors simulated: 2\n  functional equivalence: PASS\n  structural validity: PASS (no floating output, no VDD-GND short)"
